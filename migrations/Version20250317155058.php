 ...
 */
final class Version20250317155058 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tasks ADD task_rank INT DEFAULT 1 NOT NULL, ADD task_column_rank INT DEFAULT 1 NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tasks DROP task_rank, DROP task_column_rank');
